...
type GetReplicaStateRequest struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Filename         string                 `protobuf:"bytes,1,opt,name=filename,proto3" json:"filename,omitempty"`
	RequestingNodeId string                 `protobuf:"bytes,2,opt,name=requesting_node_id,json=requestingNodeId,proto3" json:"requesting_node_id,omitempty"`
	unknownFields    protoimpl.UnknownFields
...
func (x *GetReplicaStateRequest) Reset() {
	*x = GetReplicaStateRequest{}
	mi := &file_coordination_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetReplicaStateRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetReplicaStateRequest) ProtoMessage() {}

func (x *GetReplicaStateRequest) ProtoReflect() protoreflect.Message {
	mi := &file_coordination_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetReplicaStateRequest.ProtoReflect.Descriptor instead.
func (*GetReplicaStateRequest) Descriptor() ([]byte, []int) {
	return file_coordination_proto_rawDescGZIP(), []int{8}
}

func (x *GetReplicaStateRequest) GetFilename() string {
	if x != nil {
		return x.Filename
	}
	return ""
...
func (x *GetReplicaStateRequest) GetRequestingNodeId() string {
	if x != nil {
		return x.RequestingNodeId
	}
	return ""
...
type GetReplicaStateResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	LastOperationId int32                  `protobuf:"varint,1,opt,name=last_operation_id,json=lastOperationId,proto3" json:"last_operation_id,omitempty"`
	PendingOps      int32                  `protobuf:"varint,2,opt,name=pending_ops,json=pendingOps,proto3" json:"pending_ops,omitempty"`
...
func (x *GetReplicaStateResponse) Reset() {
	*x = GetReplicaStateResponse{}
	mi := &file_coordination_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetReplicaStateResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetReplicaStateResponse) ProtoMessage() {}

func (x *GetReplicaStateResponse) ProtoReflect() protoreflect.Message {
	mi := &file_coordination_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetReplicaStateResponse.ProtoReflect.Descriptor instead.
func (*GetReplicaStateResponse) Descriptor() ([]byte, []int) {
	return file_coordination_proto_rawDescGZIP(), []int{9}
}

func (x *GetReplicaStateResponse) GetLastOperationId() int32 {
	if x != nil {
...
func (x *GetReplicaStateResponse) GetPendingOps() int32 {
	if x != nil {
		return x.PendingOps
	}
	return 0
...
func (x *GetReplicaStateResponse) GetFileHash() string {
	if x != nil {
		return x.FileHash
	}
	return ""
...
func (x *GetReplicaStateResponse) GetFileSize() int64 {
	if x != nil {
		return x.FileSize
	}
	return 0
...
const file_coordination_proto_rawDesc = "" +
	...
	"\x0einvolved_nodes\x18\x04 \x03(\tR\rinvolvedNodes\"b\n" +
	"\x16GetReplicaStateRequest\x12\x1a\n" +
	"\bfilename\x18\x01 \x01(\tR\bfilename\x12,\n" +
	"\x12requesting_node_id\x18\x02 \x01(\tR\x10requestingNodeId\"\xa0\x01\n" +
	"\x17GetReplicaStateResponse\x12*\n" +
	"\x11last_operation_id\x18\x01 \x01(\x05R\x0flastOperationId\x12\x1f\n" +
	"\vpending_ops\x18\x02 \x01(\x05R\n" +
	"pendingOps\x12\x1b\n" +
	"\tfile_hash\x18\x03 \x01(\tR\bfileHash\x12\x1b\n" +
	"\tfile_size\x18\x04 \x01(\x03R\bfileSize2\xeb\x02\n" +
	...
	"\tMergeFile\x12\x13.hydfs.MergeRequest\x1a\x14.hydfs.MergeResponse\x12P\n" +
	"\x0fGetReplicaState\x12\x1d.hydfs.GetReplicaStateRequest\x1a\x1e.hydfs.GetReplicaStateResponseB Z\x1ehydfs/protoBuilds/coordinationb\x06proto3"
...
var file_coordination_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_coordination_proto_goTypes = []any{
	...
	(*GetReplicaStateRequest)(nil),  // 8: hydfs.GetReplicaStateRequest
	(*GetReplicaStateResponse)(nil), // 9: hydfs.GetReplicaStateResponse
}
var file_coordination_proto_depIdxs = []int32{
	...
	8, // 4: hydfs.CoordinationService.GetReplicaState:input_type -> hydfs.GetReplicaStateRequest
	1, // 5: hydfs.CoordinationService.HealthCheck:output_type -> hydfs.HealthCheckResponse
	3, // 6: hydfs.CoordinationService.GetNodeStatus:output_type -> hydfs.NodeStatusResponse
	5, // 7: hydfs.CoordinationService.ListFiles:output_type -> hydfs.ListFilesResponse
	7, // 8: hydfs.CoordinationService.MergeFile:output_type -> hydfs.MergeResponse
	9, // 9: hydfs.CoordinationService.GetReplicaState:output_type -> hydfs.GetReplicaStateResponse
